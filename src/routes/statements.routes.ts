...
import { TransferAmountToUserController } from "../modules/statements/useCases/transferAmountToUser/TransferAmountToUserController";
...
const transferAmountToUserController = new TransferAmountToUserController();
...
statementRouter.post(
  "/transfers/:user_id",
  transferAmountToUserController.execute
);
